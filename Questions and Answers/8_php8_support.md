...
# PHP 8.0 Support
WordPress Core in its 5.6 release is taking the first step to support PHP 8.0. It is a good time to start planning to migrate your WordPress products, services and sites to the latest PHP version. 
