...
⋅⋅1. jQuery version: Default (This will be the default jQuery version used in the WordPress Core)
⋅⋅1. jQuery Migrate: Disable (Keep it disabled for WordPress 5.5.)
⋅⋅1. jQuery UI version: Default
